...
namespace LocacaoVeiculos
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create(Cliente cliente)
        {
            ...
            {
                Endereco end = cliente._Endereco;
            ...
            ViewBag.EnderecoID = new SelectList(db.Enderecos, "EnderecoID", "Rua", cliente.EnderecoID);
            return View(cliente);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClienteID,Nome,Cpf,DtNascimento,EnderecoID")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            Cliente cliente = db.Clientes.Find(id);
            Endereco end = db.Enderecos.Find(cliente._Endereco.EnderecoID);
